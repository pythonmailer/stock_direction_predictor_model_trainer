...
if __name__ == "__main__":
    ...
    with mlflow.start_run(run_name=f"Model_Training_{model_architecture}_{run_id}") as training_run:
        ...
        trainer = DeepLearningTrainer(model, criterion, optimizer, device, epochs, patience, input_example, hp.get("model_type", "dl_model"))
    ...
    bt = Backtester(training_run)
    loaded_model = bt.load_model(training_run_id)
